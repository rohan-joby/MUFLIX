...
export const IMAGE_URL = `https://image.tmdb.org/t/p/${IMAGE_SIZE}`;
...
export const ENDPOINTS = {
    sections: [
      ...
      },
      {
        ...
        endpoint: `/discover/movie?api_key=${API_KEY}&with_networks=213&with_watch_providers=8&watch_region=IN`,
        size: 'large',
      },
      {
        title: 'Playing in Australian Cinemas',
        endpoint: `movie/now_playing?api_key=${API_KEY}&language=en-US&page=1&region=IN`,
      },
      {
        title: 'Sci-Fi',
